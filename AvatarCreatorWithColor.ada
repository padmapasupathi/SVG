...
theFace affect model =
    let
        ...
        --lefteyebrows = curve (10,18) [Pull (35,((0+60)/3)+10)(60, 18)] |> outlined  (solid 6) black |> move (30,20) |> scale 0.4--(55,18)

        {-case affect of
            Angry x ->
               curve (10,18) [Pull (35,((0+60)/3)+10)(60, 18)]
           } Sad x ->
                curve (10,18) [Pull (35,((0+60)/3)+10)(60, 18)]--curve (-60,18) [Pull (35,-30)(-10, 18)]
            _ -> curve (-60,18) [Pull (35,-30)(-10, 18)] -}

        --righteyebrows = curve (-60,18) [Pull (-35,((0+60)/3)+10)(-10, 18)] |> outlined  (solid 6) black |> move (-30,20) |> scale 0.4 --(-55,18)

        {-case affect of
            Angry x ->
                curve (-60,18) [Pull (-35,((x+60)/3)+10)(-10, 18)]
            Sad x ->
                curve (-60,18) [Pull (-35,((x+60)/3)+10)(-10, 18)]-- curve (-60,18) [Pull (-35,-30)(-10, 18)]
            _ -> curve (-60,18) [Pull (35,-30)(-10, 18)] -}
...
phone = group [ polygon [(0,0), (20,-5), (20,-55), (0,-50)] |> filled black
            ...
            ,group [
              ...
              ,text "#"
                ...
                ] |> move (-65,20) --modified x value (-115 to -65)
                  |> rotate (degrees 5)
                  |> scale (1.5)
...
hair1f model = group [
             ...
             oval 63 43 |> filled black |> move(0,10) --(0,5)
              ...
              ,oval 60 40 |> filled (myHairColour model.hairColour) |> move(0,10) --(0,5)
...
hair7  = rgb 181 82 57 -- light red
hair8  = rgb 141 74 67 -- dark red
hair9  = rgb 145 85 61 -- light auburn
hair10 = rgb 83 61 50 -- dark auburn
hair11 = rgb 59 48 36 -- Dark brown --EEH
hair12 = rgb 106 78 66 -- brown
hair13 = rgb 102 79 60 -- light brown
hair14 = rgb 151 121 97 -- Ash brown --ew
...
type HairFront = HairF1 | HairF2 | HairF3 | HairF4 | HairF5
                  ...
                  | Hijab ClothColour
                  | Turban ClothColour
                  | TurbanWithBeard ClothColour

changeCover hf =
  case hf of
    Hijab clr -> Turban clr
    Turban clr -> TurbanWithBeard clr 
    TurbanWithBeard _ -> HairF1
    _ -> Hijab ClothRed

type ClothColour = ClothRed | ClothYellow | ClothBlue

cycleCC clr =
  case clr of
    ClothRed -> ClothYellow
    ClothYellow -> ClothBlue
    ClothBlue -> ClothRed

clothColour cc =
  case cc of
    ClothRed -> rgb 255 0 0
    ClothBlue -> rgb 0 0 255
    ClothYellow -> rgb 255 255 0

clothShadow cc =
  case cc of
    ClothRed -> rgb 150 0 0
    ClothBlue -> rgb 0 0 150
    ClothYellow -> rgb 150 150 0
...
changeHairFront old = case old of
                  ...
                  HairF12 -> HairF13
                  HairF13 -> HairF1
                  Hijab clr -> Hijab (cycleCC clr)
                  Turban clr -> Turban (cycleCC clr)
                  TurbanWithBeard clr -> TurbanWithBeard (cycleCC clr)
...
myHairFront hair = case hair of
                  ...
                  HairF13 -> hair13f
                  Hijab clr -> hijab clr
                  Turban clr -> turban False clr
                  TurbanWithBeard clr -> turban True clr

--hijab
hijab clr model = group [
                       wedge 75 0.65 |> filled (clothColour clr) |> rotate (degrees 90) |> move (0,-15) |> scaleY 0.8
                      , curve (-50,0) [Pull (0,-87)(60,0), Pull (0,-26) (-50,0) ] |> filled (clothColour clr) |> rotate (degrees 90) |> move (50,-38) |>scaleY 1.5
                      , curve (-50,0) [Pull (0,-87)(60,0), Pull (0,-26) (-50,0) ] |> filled (clothColour clr) |> rotate (degrees 90)|> mirrorX  |> move (-50,-38) |>scaleY 1.5 
                      , curve (-56,0) [Pull (0,-60) (72,9), Pull (0,-20) (-45,19) ] |> filled (clothColour clr) |> rotate (degrees -30) |> move (-34,-100) |> scaleY 1  
                      , curve (-56,0) [Pull (0,-60) (72,9), Pull (0,-20) (-45,19) ] |> filled (clothColour clr) |> rotate (degrees -30) |> mirrorX |>  move (34,-100) |> scaleY 1
                      , curve (-56,0) [Pull (0,-60) (72,9), Pull (0,-20) (-45,19) ] |> filled (clothColour clr) |> mirrorX |> move (35,-140)
                      , curve (-56,0) [Pull (0,-60) (72,9), Pull (0,-20) (-45,19) ] |> filled (clothColour clr) |> move (-35,-140)
                      , curve (-56,0) [Pull (0,-60) (72,9), Pull (0,-20) (-45,19) ] |> filled black |> makeTransparent 0.25 |> rotate(degrees 2) |> move (-25,-122)
                      , curve (-56,0) [Pull (0,-60) (72,9), Pull (0,-20) (-45,19) ] |> filled (clothColour clr) |> move (-25,-120)
                      , curve (-56,0) [Pull (0,-60) (72,9), Pull (0,-20) (-45,19) ] |> filled (clothColour clr) |> mirrorX |> move (25,-122)
...
--turban
turban withBeard clr model = group
  [ if withBeard then beard model else group []
  , wedge 90 0.65 |> filled (clothColour clr)
    |> rotate (degrees 90)
    |> move (0,-10)
  , polygon [(0,2),(90,0),(0,-2),(0,2)]
    |> filled (clothShadow clr)
    |> rotate (degrees 30)
    |> move (0,-10)
  ]
